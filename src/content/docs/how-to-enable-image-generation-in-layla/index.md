...
![Stable Diffusion mini-app showing the local model selector and download control.](./choose-local-model.jpg)
...
![Image Generation section in Layla's Inference Settings.](./image-generation-settings.jpg)

Tap *Add Custom Model*. You will be able to configure your API settings:

![Custom image model API settings for connecting Layla to a PC.](./custom-model-api-settings.jpg)
...
![Stable Diffusion model selector showing a custom model running on a PC.](./select-pc-model.jpg)
...
![Image-generation models provided by Layla Cloud, marked with butterfly icons.](./layla-cloud-models.png)
...
![Character creation screen showing its image-generation configuration.](./character-image-generation.jpg)
