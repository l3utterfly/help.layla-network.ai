...
![Example Tasker chain using a variable and Layla's Create Infer Task action.](./tasker-chain.jpg)
...
![Configurable options for a Layla inference task in Tasker.](./infer-task-options.jpg)

Layla also exposes a *Task Completed* event:

![Layla Task Completed event in Tasker.](./task-completed-event.jpg)
