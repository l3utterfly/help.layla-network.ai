...
![Neon cyber cat logo with code symbols on a dark background.](./codekitty-logo.avif)
...
![Code editor showing a JSON patch with search and replace entries.](./json-patch.avif)
...
![Code editor showing JavaScript stream handlers for Layla chat content, reasoning events, and finalContent().](./streaming-events.avif)
