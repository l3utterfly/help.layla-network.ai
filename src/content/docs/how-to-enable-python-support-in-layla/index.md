...
![Layla Agents mini-app details screen.](./agents-mini-app.jpg)

![Layla Python Interpreter mini-app details screen.](./python-interpreter-mini-app.jpg)
...
![Python Interpreter running a print Hello Layla script and showing its console output.](./hello-layla-python.jpg)
...
![Python Interpreter Package Manager installing the requests package.](./install-python-package.jpg)
...
![Layla Agents list with a duplicated Test Python code agent.](./duplicate-agent.jpg)

Edit this new agent:

![Layla Edit Agent screen with Python configured as a phrase trigger.](./python-agent-trigger.jpg)
...
![Layla Edit Agent screen listing tools, including Execute Python code.](./add-execute-python-tool.jpg)
...
![Layla Execute Python code tool configured with a simple print statement.](./configure-python-tool.jpg)
...
![Layla chat reporting that it finished executing Python code.](./python-agent-execution.jpg)

![Layla chat responding with Hello from Python code.](./python-agent-response.jpg)
