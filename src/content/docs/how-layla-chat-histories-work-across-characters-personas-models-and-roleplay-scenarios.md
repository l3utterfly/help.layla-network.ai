...
![Dark Messages screen with an avatar row, Search Messages bar, and two Layla chats showing truncated previews and delete icons.](/assets/articles/how-layla-chat-histories-work-across-characters-personas-models-and-roleplay-scenarios/chat-history-messages.gif)
