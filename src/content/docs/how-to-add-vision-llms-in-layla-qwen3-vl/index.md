...
![Hugging Face file list with the Qwen3-VL 2B Q4_K_M GGUF file highlighted.](./qwen-model-download.png)

Scroll down a bit and find the **mmproj-F16** file:

![Hugging Face file list with the Qwen3-VL mmproj-F16 GGUF file highlighted.](./mmproj-download.png)
...
![Layla Inference Settings with Add Custom Model highlighted.](./add-custom-model.jpg)

![Layla inference-engine picker with Internal Storage highlighted.](./pick-internal-storage.jpg)

Your settings should look like this afterwards. Note the **Q4_K_M** suffix in your selected model:

![Layla Inference Settings showing the selected Qwen3-VL Q4_K_M model.](./selected-qwen-model.jpg)

Next, go to the **LLM Vision** section and select your `mmproj` file. Your settings should look like this:

![Layla LLM Vision setting showing the selected Qwen3-VL mmproj-F16 model.](./selected-mmproj-model.jpg)
