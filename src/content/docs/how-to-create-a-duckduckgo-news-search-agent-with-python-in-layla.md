...
![Layla Edit Agent screen naming the copy DuckDuckGo News Search (Python).](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/agent-name-description.jpg)

**Step 2: Add triggers**

Let's add a few triggers to this agent.

![Layla Edit Agent screen listing the available trigger types.](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/agent-trigger-options.jpg)
...
![Agent trigger configured with the News Query intent.](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/news-query-intent.jpg)

![Agent phrase trigger configured with the word News.](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/news-phrase-trigger.jpg)
...
![Python imports for requests, re, and html.](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/python-imports.png)
...
![Python code assigning the Layla input template to QUERY and setting LIMIT to 5.](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/python-query-input.png)
...
![Python loop that prints each news result's title, source, summary, and URL.](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/python-print-results.png)
...
![Layla Edit Agent screen containing the DuckDuckGo Python script.](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/agent-python-tool.jpg)
...
![Layla chat showing the news phrase triggering Python code execution.](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/news-agent-triggered.jpg)
...
![Layla chat showing a response based on five DuckDuckGo News results.](/assets/articles/how-to-create-a-duckduckgo-news-search-agent-with-python-in-layla/news-agent-response.jpg)
