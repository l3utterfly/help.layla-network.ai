...
![Edit Agent screen for Layla Introspection, showing several Layla Tool Triggers.](/assets/articles/full-mcp-support-in-layla/introspection-agent.jpg)
...
![MCP Support mini-app overview.](/assets/articles/full-mcp-support-in-layla/mcp-support-mini-app.jpg)
...
![MCP Support screen with a remote server URL and controls to discover tools and create an Agent.](/assets/articles/full-mcp-support-in-layla/discover-mcp-tools.jpg)
...
![Generated Fetch Agent with its MCP Tool Trigger configuration.](/assets/articles/full-mcp-support-in-layla/generated-fetch-agent.jpg)
...
![Advanced tab in the Create Character screen.](/assets/articles/full-mcp-support-in-layla/character-advanced-tab.jpg)

Tap *Select Agents* to open the popup.

![Available Agents popup listing the Fetch Agent and other Agents.](/assets/articles/full-mcp-support-in-layla/available-agents.jpg)

Select the *Fetch* Agent. It will appear in the list.

![Create Character screen showing the Fetch Agent attached to the character.](/assets/articles/full-mcp-support-in-layla/fetch-agent-selected.jpg)
...
![Chat with Kip showing an MCP tool call.](/assets/articles/full-mcp-support-in-layla/mcp-tool-call.jpg)
...
![Kip responding in character with information obtained through the MCP tool.](/assets/articles/full-mcp-support-in-layla/personalized-mcp-response.jpg)
