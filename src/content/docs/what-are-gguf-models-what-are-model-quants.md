...
![Files and versions tab in the Stheno-Mahou Hugging Face repository.](/assets/articles/what-are-gguf-models-what-are-model-quants/files-and-versions-tab.png)

### Step 2 — Open the Files and versions tab

This is where Hugging Face lists every downloadable variant of the model.

![List of quantized model files in a Hugging Face repository.](/assets/articles/what-are-gguf-models-what-are-model-quants/model-files.png)
...
![Download button beside a GGUF quant in a Hugging Face repository.](/assets/articles/what-are-gguf-models-what-are-model-quants/download-quant.png)
...
![LLM section of Layla's Inference Settings.](/assets/articles/what-are-gguf-models-what-are-model-quants/llm-settings.png)

![Add a Custom Model screen in Layla.](/assets/articles/what-are-gguf-models-what-are-model-quants/add-custom-model.png)

![Local file option for adding a custom model in Layla.](/assets/articles/what-are-gguf-models-what-are-model-quants/choose-local-file.png)
...
![Prompt-format selector for a custom model in Layla.](/assets/articles/what-are-gguf-models-what-are-model-quants/prompt-format.png)
