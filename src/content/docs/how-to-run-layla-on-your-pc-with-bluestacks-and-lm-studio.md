...
![Dark Layla landing page with smartphone mockups and app download buttons.](/assets/articles/how-to-run-layla-on-your-pc-with-bluestacks-and-lm-studio/download-layla.avif)
...
![BlueStacks showing Layla's Select Character screen, search bar, and character categories.](/assets/articles/how-to-run-layla-on-your-pc-with-bluestacks-and-lm-studio/bluestacks-select-character.avif)
...
![LM Studio model selection dialog listing downloaded AI models and their sizes.](/assets/articles/how-to-run-layla-on-your-pc-with-bluestacks-and-lm-studio/lm-studio-model-selection.avif)
...
![LM Studio Developer Local Server screen with the server running and the server settings highlighted.](/assets/articles/how-to-run-layla-on-your-pc-with-bluestacks-and-lm-studio/lm-studio-server-settings.avif)
...
![LM Studio Developer screen showing the local server, OpenAI-compatible endpoints, and logs, with the chat completions endpoint highlighted.](/assets/articles/how-to-run-layla-on-your-pc-with-bluestacks-and-lm-studio/lm-studio-api-endpoints.avif)
...
![Layla dialog for choosing an inference engine, with options for Local File, Your PC, Layla Cloud, OpenAI API, and Claude API.](/assets/articles/how-to-run-layla-on-your-pc-with-bluestacks-and-lm-studio/layla-inference-engine.avif)
...
![Layla's Edit OpenAI API Settings dialog with name, endpoint, API key, and model fields.](/assets/articles/how-to-run-layla-on-your-pc-with-bluestacks-and-lm-studio/layla-api-settings.avif)
...
![Layla chat running through LM Studio, with a user asking “Who are you?” and Layla replying.](/assets/articles/how-to-run-layla-on-your-pc-with-bluestacks-and-lm-studio/layla-chat-via-lm-studio.avif)
