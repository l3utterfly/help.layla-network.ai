...
![Layla Agents screen showing the DuckDuckGo web and news search agents.](./duplicate-duckduckgo-agent.jpg)
...
![Layla Eval tool configured to encode the input as a URI component.](./eval-encode-input.jpg)
...
![Layla HTTP Request tool configured for the Brave Search API.](./brave-http-request.jpg)
...
![Layla Eval tool containing JavaScript that parses the Brave Search results.](./eval-parse-results.jpg)
...
![Layla Provide Context tool configured with instructions for the Brave Search results.](./provide-context.jpg)
