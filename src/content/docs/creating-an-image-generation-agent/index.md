...
![Chat showing a generated image of a mountain scene with a waterfall.](./image-agent-in-action.jpg)
...
![Image generation Agent settings, including its regex trigger.](./image-agent-triggers.jpg)

![Structured Output tool configured with grammar for the Stable Diffusion prompt tags.](./structured-output-grammar.jpg)
...
![Character Scenario instructions telling the LLM to add image-generation keywords.](./character-scenario-instructions.jpg)
