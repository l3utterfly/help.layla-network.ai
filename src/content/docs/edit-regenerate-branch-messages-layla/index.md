...
![Dark-mode chat with Layla showing a reply from the assistant.](./open-message-actions.gif)
...
![Layla message menu showing Copy, Edit, Regen, Continue, Delete, and Speak actions.](./edit-message.gif)
...
![Layla chat demonstrating a regenerated assistant reply.](./regenerate-message.gif)
...
![Layla conversation demonstrating a branch from an earlier message.](./branch-conversation.gif)
