---
title: How to hear your characters speak in Layla
description: Three ways to hear a character's voice in Layla - full voice chat, automatic spoken responses, and speaking a single message.
...
![Full-screen voice chat with an animated character. A red "Stop Voice Chatting" button sits at the bottom, with a plus button on the left and a pause button on the right.](./voice-chat.jpg)
...
![The Chat Actions menu with Image, Camera, File, Reference, Push to Talk, Quick Prompts, Speak Responses, and Add Instruction. The Speak Responses option is highlighted to show it is active.](./speak-responses.jpg)
...
![A message's action menu showing Copy, Edit, Regen, Continue, Delete, Speak, Generate Image, and Translate options.](./speak.jpg)
