...
![Red arrow pointing at the Download APK link on the F-Droid SherpaTTS page.](/assets/articles/how-to-add-multilingual-text-to-speech-for-your-characters-in-layla/fdroid-download-apk.png)
...
![SherpaTTS screen with the add-model button circled.](/assets/articles/how-to-add-multilingual-text-to-speech-for-your-characters-in-layla/sherpatts-add-model.jpg)

Tap the plus sign to add a new model.

You will be presented with a list of models:

![SherpaTTS language-download screen listing Piper and Coqui models.](/assets/articles/how-to-add-multilingual-text-to-speech-for-your-characters-in-layla/sherpatts-download-language.jpg)
...
![SherpaTTS screen with an arrow pointing to the settings button.](/assets/articles/how-to-add-multilingual-text-to-speech-for-your-characters-in-layla/sherpatts-settings.jpg)

This will bring up your Android system settings. Tap the **Default Text-to-Speech** setting:

![Android Text-to-speech settings with Preferred engine circled.](/assets/articles/how-to-add-multilingual-text-to-speech-for-your-characters-in-layla/android-tts-preferred-engine.jpg)

You will be able to change the default engine. Change it to SherpaTTS:

![Android Preferred engine screen with SherpaTTS selected and circled.](/assets/articles/how-to-add-multilingual-text-to-speech-for-your-characters-in-layla/select-sherpatts-engine.jpg)
...
![Layla Create Character screen on the Advanced tab with the Voice setting circled.](/assets/articles/how-to-add-multilingual-text-to-speech-for-your-characters-in-layla/layla-character-advanced-voice.jpg)

Select your new voices in the **Native** section:

![Layla Select Voice screen with the Native filter and installed voices circled.](/assets/articles/how-to-add-multilingual-text-to-speech-for-your-characters-in-layla/layla-native-voices.jpg)
