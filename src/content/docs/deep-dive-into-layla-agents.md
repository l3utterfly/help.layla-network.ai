...
![Flowchart showing chat input triggering tools within an Agent, leading to the Agent result.](/assets/articles/deep-dive-into-layla-agents/agent-workflow.jpg)
...
![Layla interface displaying Intent, Regex, Phrase, Date or Time, MCP Tool, Layla Tool, and Voice Mode triggers.](/assets/articles/deep-dive-into-layla-agents/trigger-types.jpg)
...
![HTTP Request tool information showing its URL, method, and headers parameters.](/assets/articles/deep-dive-into-layla-agents/http-request-tool.jpg)
...
![Edit Agent screen configuring an HTTP Request to the Meow Facts API.](/assets/articles/deep-dive-into-layla-agents/http-request-config.jpg)
...
![Test Agent dialog showing the steps and result for the What's My IP Agent.](/assets/articles/deep-dive-into-layla-agents/test-ip-agent.jpg)
...
![Provide Context configuration using the user and input templates for an IP address.](/assets/articles/deep-dive-into-layla-agents/provide-context-templates.jpg)
...
![Edit Agent screen showing the Send Email tool with subject and message fields.](/assets/articles/deep-dive-into-layla-agents/send-email-llm-tool.jpg)
